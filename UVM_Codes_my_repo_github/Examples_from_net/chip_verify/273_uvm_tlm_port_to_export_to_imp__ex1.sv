...
// Category : UVM
// Link     : https://www.edaplayground.com/x/4iNB
// Filename : 273_uvm_tlm_port_to_export_to_imp__ex1.sv
//--------------------------------------------------
...
typedef class subCompB1;
typedef class subCompB2;
  ...
  // Repeat these steps N times to send N packets
   virtual task run_phase (uvm_phase phase);
     ...
     repeat (m_num_tx) begin
       ...
       `uvm_info ("SUBCOMPA", "Packet sent to subCompB2", UVM_LOW)
...
class componentB extends uvm_component;
  ...
  function new(string name, uvm_component parent);
	...
	subCompB1 m_subcomp_B1;
   uvm_blocking_put_export#(Packet) m_put_export;
 
  virtual function void build_phase(uvm_phase phase);
    super.build_phase(phase);
    m_subcomp_B1 = subCompB1::type_id::create("m_subcomp_B1", this);
...
// subCompB1 gets the packet on its Export
...
class subCompB1 extends uvm_component;
  ...
  function new(string name, uvm_component parent);
	...
	subCompB2 m_subcomp_B2;
   uvm_blocking_put_export#(Packet) m_put_export;
 
  virtual function void build_phase(uvm_phase phase);
    super.build_phase(phase);
    m_subcomp_B2 = subCompB2::type_id::create("m_subcomp_B2", this);
    m_put_export = new("m_put_export", this);
  endfunction
 
  // Connection with subCompB2
  virtual function void connect_phase(uvm_phase phase);
...
class subCompB2 extends uvm_component;
  ...
  uvm_blocking_put_imp #(Packet, subCompB2) m_put_imp;
   ...
   virtual function void build_phase (uvm_phase phase);
    ...
    // Implementation of the 'put()' method in this case simply prints it.
      ...
      `uvm_info ("SUBCOMPB2", "Packet received from subCompA", UVM_LOW)
      pkt.print(uvm_default_line_printer);
   endtask
endclass
