...
module top;
  ...
  initial begin
    environment = new("env");   // if you will try to create by env::type_id::create("environment",null) --> will throw an error "type_id" not define, for that you need to add `uvm_component_utils in the env 
				// for factory registration need to add `uvm_component_utils(env) in the env class 
